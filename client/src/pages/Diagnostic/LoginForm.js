...
const DiagnosticLoginForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const user = await contract.centers(wallet);
      
      if (!user.exists) {
        throw new Error('No diagnostic center registered with this wallet address');
      }
  ...
  const features = [
    ...
    },
    {
      ...
      text: "Manage patient test results"
    },
    {
          ...
          <div className="animate-slide-in-left">
            <Card className="border-0 shadow-xl">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-2xl">Welcome Back, Diagnostic Center</CardTitle>
                <CardDescription>
                  Sign in to upload diagnostic reports and manage patient test results securely.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="text-center">
                    <p className="text-sm text-gray-600">
                      ...
                      <a href="/register/diagnostic" className="font-medium text-purple-600 hover:text-purple-500">
                        Register here
                      </a>
                    </p>
                  </div>
          ...
          <div className="space-y-8 animate-slide-in-right">
            <div>
              <Badge variant="secondary" className="bg-purple-100 text-purple-800 border-purple-200 mb-4">
                ...
                Secure Diagnostic Portal
              </Badge>
              <h2 className="text-3xl font-bold text-gray-900 mb-4">
                Advanced Diagnostic Management
              </h2>
              <p className="text-lg text-gray-600 mb-8">
                Streamline your diagnostic operations with secure report uploads, 
                patient result management, and comprehensive analytics tools.
              </p>
            </div>
            ...
            <Card className="border-0 shadow-lg bg-gradient-to-r from-purple-50 to-indigo-50">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Our technical support team is available 24/7 to help diagnostic centers.
                </p>
