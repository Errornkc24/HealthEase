...
const PatientLoginForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const user = await contract.patients(wallet);
      
      if (!user.exists) {
        throw new Error('No patient registered with this wallet address');
      }
  ...
  const features = [
    {
      ...
      text: "Blockchain-secured medical records"
    },
    {
    ...
    },
    {
      ...
      text: "HIPAA compliant and secure"
    }
  ];
          ...
          <div className="animate-slide-in-left">
            <Card className="border-0 shadow-xl">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-2xl">Welcome Back, Patient</CardTitle>
                <CardDescription>
                  Sign in to access your blockchain-secured medical records and manage your healthcare data.
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <div className="space-y-8 animate-slide-in-right">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Access your medical records securely through blockchain technology. 
                Your data is encrypted, decentralized, and completely under your control.
              </p>
            </div>
            ...
            <Card className="border-0 shadow-lg bg-gradient-to-r from-blue-50 to-indigo-50">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Our support team is available 24/7 to assist you with any questions about your account or medical records.
                </p>
